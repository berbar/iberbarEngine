...
namespace iberbar
{
	namespace IO
	{
		extern "C" __iberbarNetworkApis__ void iberbarNetworkRegisterLuaCpp( lua_State * pLuaState );
...
extern "C" void iberbar::IO::iberbarNetworkRegisterLuaCpp( lua_State* pLuaState )
{
	...
	builder.ResolveScope(
		[]( Lua::CScopeBuilder* pScope )
		{
			...
			pScope->AddClass( LuaCppNames::s_ClassName_SocketClient,
				...
				{
					pClass->AddDistructor( &Lua::Class_Unknown_Distructor_Release<ISocketClient> );
			...
			pScope->AddClass( LuaCppNames::s_ClassName_SocketProtocolHead, []( const char*, Lua::CClassBuilder* pClass ) {} );
