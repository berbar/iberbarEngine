...
void LuaCpp_CFoo(const char*, iberbar::LuaCpp::CClassBuilder* classBuilder)
{
	...
	classBuilder->AddConstructor( &iberbar::LuaCpp::Class_Unknown_Constructor_New<CFoo> );
	classBuilder->AddDistructor( &iberbar::LuaCpp::Class_Unknown_Distructor_Release<CFoo> );
}

void LuaCpp_CFooNumbers( const char*, iberbar::LuaCpp::CClassBuilder* classBuilder )
{
	classBuilder->AddConstructor( &iberbar::LuaCpp::Class_Unknown_Constructor_New<CFooNumbers> );
	classBuilder->AddDistructor( &iberbar::LuaCpp::Class_Unknown_Distructor_Release<CFooNumbers> );
...
int main()
{
	...
	iberbar::LuaCpp::CBuilder builder( pLuaState );
	builder.ResolveScope( []( iberbar::LuaCpp::CScopeBuilder* scope )
	{
		//luaL_Reg cfs[] = {
